{{-- Main Sidebar Container --}}
    ...
    {{-- Brand Logo --}}
        <a href="#" class="brand-link">
            <img src="{{ asset('adminPanel/uploads/logos/logo.jpg') }}" alt="Logo" class="brand-image img-circle elevation-3"
                style="opacity: .8">
        ...
        <div class="sidebar">
            {{-- Sidebar user panel (optional) --}}
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('adminPanel/uploads/users/user.png') }}" class="img-circle elevation-2" alt="User Image">
                    </div>
