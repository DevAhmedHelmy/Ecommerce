        ...
        <div id="rev_slider_1_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8.1">
            <ul>
                ...
                <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="assets/100x50_44515-slider-bg-3.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide 3" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('frontend/shop/img/slider-bg-3.jpg')}}"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" alt="slider-image" data-no-retina>
                    <!-- LAYERS -->
                ...
                <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="assets/100x50_129c3-slider-bg-2.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide 2" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('frontend/shop/img/slider-bg-2.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                ...
                <li data-index="rs-4" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="assets/100x50_9a2ac-slider-bg-4.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide 4" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('frontend/shop/img/slider-bg-4.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 6; white-space: nowrap; font-size: 60px; line-height: 57px; font-weight: 500; color: #000000; letter-spacing: 0px;font-family:'Poppins', sans-serif;">Classic Collection </div>
                ...
                <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="assets/100x50_a1c1a-slider-bg-1.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide 1" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('frontend/shop/img/slider-bg-1.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                ...
                <div id="js-grid-blog-posts" class="cbp">
                    ...
                    <div class="cbp-item CausalShirts others wow slideInUp">
                        ...
                        <div class="cbp-caption-defaultWrap  owl-theme sync-portfolio-carousel owl-carousel">
                            <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p24.jpg')}}" class="cbp-caption" data-fancybox="gallery1" data-title="Shirt Name"><img src="{{asset('frontend/shop/img/product-listing/p24.jpg')}}" alt=""></a></div>
                            <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p25.jpg')}}" class="cbp-caption" data-fancybox="gallery1" data-title="Shirt Name"><img src="{{asset('frontend/shop/img/product-listing/p25.jpg')}}" alt=""></a></div>
                        </div>
                        <div class="row">
                    ...
                    <div class="cbp-item formalShirts CausalShirts wow slideInUp">
                        ...
                        <div class="cbp-caption-defaultWrap  owl-theme sync-portfolio-carousel owl-carousel">
                            <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p26.jpg')}}" class="cbp-caption" data-fancybox="gallery2"  data-title="Shirt Name"> <img src="{{asset('frontend/shop/img/product-listing/p26.jpg')}}" alt=""></a></div>
                            <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p27.jpg')}}" class="cbp-caption" data-fancybox="gallery2"  data-title="Shirt Name"><img src="{{asset('frontend/shop/img/product-listing/p27.jpg')}}" alt=""></a></div>
                        </div>
                    ...
                    <div class="cbp-caption-defaultWrap  owl-theme sync-portfolio-carousel owl-carousel">
                        <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p30.jpg')}}" class="cbp-caption" data-fancybox="gallery3"  data-title="Shirt Name"> <img src="{{asset('frontend/shop/img/product-listing/p30.jpg')}}" alt=""></a></div>
                        <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p31.jpg')}}" class="cbp-caption" data-fancybox="gallery3" data-title="Shirt Name"><img src="{{asset('frontend/shop/img/product-listing/p31.jpg')}}" alt=""></a></div>
                    </div>
                    ...
                    <div class="cbp-item formalShirts CausalShirts wow slideInUp">
                        ...
                        <div class="cbp-caption-defaultWrap  owl-theme sync-portfolio-carousel owl-carousel">
                            <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p28.jpg')}}" class="cbp-caption" data-fancybox="gallery4" data-title="Shirt Name"> <img src="{{asset('frontend/shop/img/product-listing/p28.jpg')}}" alt=""></a></div>
                            <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p29.jpg')}}" class="cbp-caption" data-fancybox="gallery4" data-title="Shirt Name"><img src="{{asset('frontend/shop/img/product-listing/p29.jpg')}}" alt=""></a></div>
                        </div>
                    ...
                    <div class="cbp-item motion CausalShirts wow slideInUp">
                        ...
                        <div class="cbp-caption-defaultWrap  owl-theme sync-portfolio-carousel owl-carousel">
                            <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p34.jpg')}}" class="cbp-caption" data-fancybox="gallery5"  data-title="Shirt Name"> <img src="{{asset('frontend/shop/img/product-listing/p34.jpg')}}" alt=""></a></div>
                            <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p35.jpg')}}" class="cbp-caption" data-fancybox="gallery5" data-title="Shirt Name"><img src="{{asset('frontend/shop/img/product-listing/p35.jpg')}}" alt=""></a></div>
                        </div>
                    ...
                    <div class="cbp-item formalShirts CausalShirts wow slideInUp">
                        ...
                        <div class="cbp-caption-defaultWrap  owl-theme sync-portfolio-carousel owl-carousel">
                            <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p32.jpg')}}" class="cbp-caption" data-fancybox="gallery6"  data-title="Shirt Name"> <img src="{{asset('frontend/shop/img/product-listing/p32.jpg')}}" alt=""></a></div>
                            <div class="item"> <a href="{{asset('frontend/shop/img/product-listing/p33.jpg')}}" class="cbp-caption" data-fancybox="gallery6" data-title="Shirt Name"><img src="{{asset('frontend/shop/img/product-listing/p33.jpg')}}" alt=""></a></div>
                        </div>
                ...
                <div class="lastest_featured_products owl-carousel owl-theme">
                    ...
                    <div class="lastest_arrival_items item">
                        ...
                        <div class="card">
                            ...
                            <a href="{{asset('frontend/shop/img/l1.jpg')}}"  data-fancybox="lastest_product"  data-title="Shirt Name">
                                <img src="{{asset('frontend/shop/img/l1.jpg')}}" class="card-img-top" alt="Lastest Arrivals 1">
                            </a>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="lastest_arrival_items item">
                        ...
                        <div class="card">  <span class="product-type">NEW</span>
                            <div class="image-holder">
                                <a href="{{asset('frontend/shop/img/l7.jpg')}}"  data-fancybox="lastest_product"  data-title="Lastest Arrivals 1">
                            <img src="{{asset('frontend/shop/img/l7.jpg')}}" class="card-img-top" alt="Lastest Arrivals 1">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="lastest_arrival_items item">
                        ...
                        <div class="card">
                            <span class="product-type">NEW</span>
                            <div class="image-holder">
                            <a href="{{asset('frontend/shop/img/l8.jpg')}}"  data-fancybox="lastest_product"  data-title="Lastest Arrivals 1">
                            <img src="{{asset('frontend/shop/img/l8.jpg')}}" class="card-img-top" alt="Lastest Arrivals 1">
                            </a>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="lastest_arrival_items item">
                        ...
                        <div class="card">
                            <span class="product-type">NEW</span>
                            <div class="image-holder">
                            <a href="{{asset('frontend/shop/img/l9.jpg')}}"  data-fancybox="lastest_product"  data-title="Lastest Arrivals 1">
                            <img src="{{asset('frontend/shop/img/l9.jpg')}}" class="card-img-top" alt="Lastest Arrivals 1">
                            </a>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="lastest_arrival_items item">
                        ...
                        <div class="card">
                            <span class="product-type">NEW</span>
                            <div class="image-holder">
                            <a href="{{asset('frontend/shop/img/l10.jpg')}}"  data-fancybox="lastest_product"  data-title="Lastest Arrivals 1">
                            <img src="{{asset('frontend/shop/img/l10.jpg')}}" class="card-img-top" alt="Lastest Arrivals 1">
                            </a>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="lastest_arrival_items item">
                        ...
                        <div class="card">
                            <span class="product-type">NEW</span>
                            <div class="image-holder">
                            <a href="{{asset('frontend/shop/img/l11.jpg')}}"  data-fancybox="lastest_product"  data-title="Lastest Arrivals 1">
                            <img src="{{asset('frontend/shop/img/l11.jpg')}}" class="card-img-top" alt="Lastest Arrivals 1">
                            </a>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="lastest_arrival_items item">
                        ...
                        <div class="card">
                            <span class="product-type">NEW</span>
                            <div class="image-holder">
                            <a href="{{asset('frontend/shop/img/l12.jpg')}}"  data-fancybox="lastest_product"  data-title="Lastest Arrivals 1">
                            <img src="{{asset('frontend/shop/img/l12.jpg')}}" class="card-img-top" alt="Lastest Arrivals 1">
                            </a>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="lastest_arrival_items item">
                        ...
                        <div class="card">
                            ...
                            <div class="image-holder">
                                <a href="{{asset('frontend/shop/img/l7.jpg')}}"  data-fancybox="lastest_product"  data-title="Lastest Arrivals 1">
                                <img src="{{asset('frontend/shop/img/l13.jpg')}}" class="card-img-top" alt="Lastest Arrivals 1">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="row">
