...
<div class="paralax-section-slide-data1" style="background-image:url('img/banner1.1.jpg')">
</div>
                            ...
                            @if(count($products) > 0)
                                @foreach($products as $product)
                                    <div class="col-12 col-md-6 col-lg-4 manage-color-hover wow slideInUp" data-wow-delay=".2s">
                                        ...
                                        <h4 class="text-center p-item-name"><a href="{{route('show.product', $product->id)}}"> Fusion Top </a></h4>
